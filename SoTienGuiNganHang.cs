...
{
    public partial class SoTienGuiNganHang : Form
    {
        ...
        private void SoTienGuiNganHang_Load(object sender, EventArgs e)
        {
            // TODO: This line of code loads data into the 'qLRBWDsTGNH.pr_SoTienGuiNganHang_Detail' table. You can move, or remove it, as needed.
            this.pr_SoTienGuiNganHang_DetailTableAdapter.Fill(this.qLRBWDsTGNH.pr_SoTienGuiNganHang_Detail);
        ...
        public DataTable LayDuLieuSoNhatKyThuTien(DateTime ngayBD, DateTime ngayKT)
        {
            string query = @"
                                ...
                                FORMAT(SUM(CASE WHEN Buttoan.TKNO LIKE '112%' THEN Buttoan.SoLuong * Buttoan.DonGia ELSE 0 END), '#,##0', 'vi-VN') AS GhiNo_TK112,
                                FORMAT(SUM(CASE WHEN Buttoan.TKCO LIKE '111%' THEN Buttoan.SoLuong * Buttoan.DonGia ELSE 0 END), '#,##0', 'vi-VN') AS GhiCo_TK111,
                                ...
                                FORMAT(SUM(CASE 
                                    WHEN Buttoan.TKCO NOT LIKE '111%' AND Buttoan.TKCO NOT LIKE '131%'
        ...
        public DataTable LayDuLieuSoNhatKyThuTien_Header(DateTime ngayBD, DateTime ngayKT)
        {
            ...
            DataTable dt = new DataTable();
            // Thay chuỗi kết nối của bạn vào
            ...
            {
                using (SqlCommand cmd = new SqlCommand("pr_SoTienGuiNganHang_Header", conn))
                {
        ...
        private void btnXuatFile_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                FrmBaoCaoTGNH frmReport = new FrmBaoCaoTGNH();
